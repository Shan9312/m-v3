<template>
  <div>
  <div class="goods-wrapper" v-for="(item,index) of pageList" :key="index" @click="buyToast(item.id,item.businessLogo,item.discount,item.maxUserRebate,item.dealType,item.linkUrlWechat,item.businessId)">
    ...
    <div class="list-right fr">
      ...
      <div class="list-content-middle">
          <span :class="{'list-content-middle-color':item.discount}">&yen;{{!item.discount?item.marketPrice.toFixed(2):item.price.toFixed(2)}}</span>
