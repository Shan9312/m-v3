  ...
  <div class="card-buy-order" v-show="pageShow">
    ...
    <header v-else @click="link()" class="clearfix">
      <div class="fl clearfix">
        ...
        <span
          class="address"
        >收货地址：{{userDeliveryList.province + userDeliveryList.city + userDeliveryList.area + userDeliveryList.address}}</span>
      </div>
      <div class="fr">
        <img src="../../../assets/images/userDelivery/right.png" />
      </div>
    ...
    <div class="company">
      <div class="clearfix picture_view" v-for="(item,index) in shopsList" :key="index">
        ...
        <div class="fl price">
          ...
          <span class="type">数量：{{item.num}}</span>
          <br />
          <span>
            ...
            <span
              ...
              class="sellPrice"
            >{{item.shopCartPrice.toFixed(2)}}</span>
          </span>
        </div>
      </div>
    </div>
    ...
    <footer :class="{refer:userDeliveryList}">
      <div class="fl">
        ...
        <span>
          ...
          <span class="sellPrice">{{totalPrices.toFixed(2)}}</span>
        </span>
      </div>
    ...
    refer() {
      ...
      http({
        ...
        data: {
          ...
          consigneeAddr:
            this.userDeliveryList.province +
            this.userDeliveryList.city +
            this.userDeliveryList.area +
            this.userDeliveryList.address,
...
.main .picture .center {
  ...
  width: 1.6rem;
  height: 1.6rem;
  background: #f5f5f5 url(../../../assets/images/cardbuy/picture_add.png)
    no-repeat 0.6rem 0.42rem;
