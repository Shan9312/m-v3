<template>
  <div>
    ...
    <div class="isSuccess_bg approve" v-show="nonentityVisible1" @touchmove.prevent>
        <div class="isSuccess">
            ...
            <div class="input_view">
                <div @click="confirmBtn" :disabled="true">取消</div>
                <div @click="confirmRechargeBtn" class="right" :disabled="true">查看福利</div>
                <div class="line"></div>
            </div>
        </div>
    </div>
    ...
    <div class="img_div">
      <img src="../../../assets/images/World_Cup/World_Cup1.png"/>
    </div>
    <div class="img_div">
      <div class="btn_div1" data-baidu-stats="活动-世界杯活动-免费领取" @click="btn_recharge" :disabled="true"></div>
      <img src="../../../assets/images/World_Cup/World_Cup2.png"/>
    </div>
    <div class="img_div">
      <img src="../../../assets/images/World_Cup/World_Cup3.png"/>
    </div>
    <div class="img_div">
      <div class="btn_div2" @click="btn_liquorshop" :disabled="true"></div>
      <img src="../../../assets/images/World_Cup/World_Cup4.png"/>
    </div>
    <div class="img_div">
      <img src="../../../assets/images/World_Cup/World_Cup5.png"/>
    </div>
    </div>
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.Wechatshare('worldCup',"",[this.activity_id,this.coupon_id]);
    },
    created(){
    ...
    methods: {
      ...
      btn_recharge(){
        ...
        this.disabled=false;
        var starttime = new Date("2018/7/16 00:00").getTime();
...
.btn_div1{position: absolute;width:2.1rem;height: 100%;left: 4rem;}
