  ...
  <div>
    ...
    <header>
      <div class="header_img">
        <div class="buis_logo"><img src="../../assets/images/lighten_business/invite_bg.png"/></div>
                <div class="logo_bg">
                    <div class="header_logo">
                      <img v-if="wechatheadImgurl!=''" :src="wechatheadImgurl">
                      <img v-else src="../../assets/images/lighten_business/favicon.png">
                   </div>
                </div>
        <div class="div_describe">
          <div class="desc_name">{{wechatBinding_name}}</div>
          <div class="desc_infor">你的亲友发送了一条邀请给你</div>
          <div class="desc_price">一起成为{{member}}会员享受折扣之旅</div> <!-- 兜礼会员 -->
        </div>
      </div>
    </header>
      ...
      <div class="title">以下商户都可以享受兜礼专享价</div>
       <div class="line"><img src="../../assets/images/lighten_business/line.png"></div>
            <ul class="img_list clearfix">
              ...
              <li>
                  <a href="javascript:void(0);">
                      <img src="../../assets/images/lighten_business/diandianyangche.png" />
                  </a>
              </li>
              <li>
                  <a href="javascript:void(0);">
    ...
    <section class="main_div" v-show="douli_div">
        ...
        <div class="dimension_div">
            <div class="dimensionCode">
             <img src="../../assets/images/lighten_business/dimensionCode.png" v-show="code_img">
             <img src="../../assets/images/lighten_business/app.png" v-show="code_app">
             <img src="../../assets/images/lighten_business/wiscowechat.jpg" v-show="code_wiscowechat">
            </div>
            <div class="top" v-show="code_img"><span>长按识别图中二维码关注{{member}}公众号</span></div>
            <div class="top" v-show="code_app"><span>长按识别图中二维码下载兜礼APP</span></div>
        </div>
    </section><!-- 兜礼会员 -->
      <section class="main_div" v-show="e_div">
          <div class="title">激活流程</div>
          ...
          <div class="dimension_div">
              <div class="dimensionCode"><img src="../../assets/images/lighten_business/e_jia.png"></div>
              <div class="top"><span>长按识别图中二维码关注{{member}}公众号</span></div>
          </div>
      </section> <!-- 钢城e家 -->   
    </div>
  </div>
...
<script>
  ...
  export default {
      ...
      loadPageData(){
        http({//分享落地接口
          ...
          if(res.data.code == '1000'){
            ...
            this.wechatBinding_name=res.data.wechatBinding.name;
          }else{
            this.$toast("获取失败");
          }
        }
    ...
    created() {
      initTitle('邀请亲友');
      if(this.channel=="wechat"){//兜礼微信公众号
        this.code_img=true;
        this.douli_div=true;
        this.e_div=false;
      }else if(this.channel=="wiscoapp"){//武钢app
        this.e_div=true;
        this.code_wiscowechat=true;
        this.douli_div=false;  //暂时没有不武钢的APP显示关注公众账号图片
      }else if(this.channel=="wiscowechat"){//钢城e家公众号
        this.e_div=true;
        this.code_wiscowechat=true;
        this.douli_div=false;
      }else if(this.channel=="h5"){//H5
        
      }else if(this.channel=="app"){//兜礼app
        this.code_app=true;
        this.code_img=false;
      }else{
...
.buis_title{font-size: 0.36rem; color: #fff; text-align: center;}
.header_logo{text-align: center;position: absolute;height: 1.5rem;width: 1.5rem;left: 0; right: 0; margin: 0 auto; margin-top: -1.1rem}
.header_logo img{height: 1.5rem;width: 1.5rem;border-radius: 50%;border: 0.07rem solid #fff;}
.logo_bg{height:0.6rem; position: relative;width: 100%;}

.div_describe{ text-align: center; color: #333;margin-top: 0.16rem;}
.div_describe .desc_name{font-size: 0.3rem; color: #383838;}
.div_describe .desc_infor{color: #999999;margin-top: 0.2rem; font-size: 0.24rem;}
.div_describe .desc_price{color: #999999;margin-top: 0.1rem; font-size: 0.24rem;}
...
/* 商户列表  */
.img_list{margin: 0 auto;padding: 0 0.3rem;display: inline-block;font-size: 0; margin-top: 0.14rem}
.img_list li{display: inline-block; width: 1.8rem; margin-top:0.3rem;margin-right: 0.3rem; height: 1.8rem;font-size: 0}
.img_list li a{display: block;width: 1.8rem;height: 1.8rem; -webkit-tap-highlight-color:rgba(0,0,0,0);}
.img_list li a img{width: 1.8rem;height: 1.8rem;border-radius:0.1rem}
...
/*二维码*/
.dimension_div{width: 100%; margin-top: 0.5rem;}
.dimensionCode{width: 2.6rem;margin: 0 auto;}
.dimensionCode img{width:100%;}
.top{text-align: center;}
.top span{font-size: 0.2rem;color: #999999;white-space: nowrap;}
.app_con{padding-bottom:0.28rem;}
