<template>
  <div>
    ...
    <div class="explain padding_frm">
      <div class="title">{{ cardBuyDetailList.selfProduct.name }}</div>
    ...
    <div class="line_bold"></div>
    <!-- 详情 -->
    <div class="commodity_details" v-html="cardBuyDetailList.selfProduct.detail"></div>
    <!-- 返回顶部 -->
    ...
    <div v-if="!ccbType">
      ...
      <footer class="box_item" v-if="!giftBagId">
        <div class="item fl-1" v-if="!recyclingType">
          可用积分：
          <span>{{ cardBuyDetailList.availablePoint }}</span>
        </div>
        <div
          class="item fr-2"
